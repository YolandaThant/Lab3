...
public class JSONTranslationExample {
    ...
    public JSONTranslationExample() {
        try {
            ...
            // y TODO CheckStyle: Line is longer than 120 characters
    ...
    public String getCanadaCountryNameSpanishTranslation() {
        ...
        // y TODO Checkstyle: '30' is a magic number.
        JSONObject canada = jsonArray.getJSONObject(CANADA_INDEX);
        return canada.getString("es");
    }

    // y TODO Task: Complete the method below to generalize the above to get the country name
    ...
    public static void main(String[] args) {
        ...
        String translation2 = jsonTranslationExample.getCountryNameTranslation("mmr", "en");
